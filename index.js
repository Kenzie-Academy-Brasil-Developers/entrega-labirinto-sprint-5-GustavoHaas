...
document.addEventListener('keydown', (event) => {
    ...
    if (xEy === 'R') {
        pickeRick.play()
        document.getElementById('player').style.backgroundImage = 'url(../entrega-labirinto-sprint-5-GustavoHaas/assests/ratSuit.png)'
    }

    if (xEy === 'I') {
        yes.play()
        document.getElementById('player').style.backgroundImage = 'url(../entrega-labirinto-sprint-5-GustavoHaas/assests/Rick.png)'
    }
